...
```hbs
// example-2-{{kebabCase title}}/script.js
...
```hbs
/* example-2-{{kebabCase title}}/style.css */
...
Check that everything’s working, without needing the `title` prompt:
